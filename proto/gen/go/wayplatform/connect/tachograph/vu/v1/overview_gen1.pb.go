...
func (x *OverviewGen1) GetAuthentication() *v11.Authentication {
	if x != nil {
...
func (x *OverviewGen1) SetAuthentication(v *v11.Authentication) {
...
func (x *OverviewGen1) HasAuthentication() bool {
	if x == nil {
		return false
	}
...
func (x *OverviewGen1) ClearAuthentication() {
...
const file_wayplatform_connect_tachograph_vu_v1_overview_gen1_proto_rawDesc = "" +
	...
	"\x0eauthentication\x18c \x01(\v2:.wayplatform.connect.tachograph.security.v1.AuthenticationR\x0eauthentication\x1a\xa5\x02\n" +
...
var file_wayplatform_connect_tachograph_vu_v1_overview_gen1_proto_goTypes = []any{
	...
	(*v1.FullCardNumber)(nil),                    // 10: wayplatform.connect.tachograph.dd.v1.FullCardNumber
...
var file_wayplatform_connect_tachograph_vu_v1_overview_gen1_proto_depIdxs = []int32{
	...
	9,  // 9: wayplatform.connect.tachograph.vu.v1.OverviewGen1.authentication:type_name -> wayplatform.connect.tachograph.security.v1.Authentication
	6,  // 10: wayplatform.connect.tachograph.vu.v1.OverviewGen1.DownloadActivity.downloading_time:type_name -> google.protobuf.Timestamp
	10, // 11: wayplatform.connect.tachograph.vu.v1.OverviewGen1.DownloadActivity.full_card_number:type_name -> wayplatform.connect.tachograph.dd.v1.FullCardNumber
	11, // 12: wayplatform.connect.tachograph.vu.v1.OverviewGen1.DownloadActivity.company_or_workshop_name:type_name -> wayplatform.connect.tachograph.dd.v1.StringValue
	6,  // 13: wayplatform.connect.tachograph.vu.v1.OverviewGen1.CompanyLock.lock_in_time:type_name -> google.protobuf.Timestamp
	6,  // 14: wayplatform.connect.tachograph.vu.v1.OverviewGen1.CompanyLock.lock_out_time:type_name -> google.protobuf.Timestamp
	11, // 15: wayplatform.connect.tachograph.vu.v1.OverviewGen1.CompanyLock.company_name:type_name -> wayplatform.connect.tachograph.dd.v1.StringValue
	11, // 16: wayplatform.connect.tachograph.vu.v1.OverviewGen1.CompanyLock.company_address:type_name -> wayplatform.connect.tachograph.dd.v1.StringValue
	10, // 17: wayplatform.connect.tachograph.vu.v1.OverviewGen1.CompanyLock.company_card_number:type_name -> wayplatform.connect.tachograph.dd.v1.FullCardNumber
	12, // 18: wayplatform.connect.tachograph.vu.v1.OverviewGen1.ControlActivity.control_type:type_name -> wayplatform.connect.tachograph.dd.v1.ControlType
	6,  // 19: wayplatform.connect.tachograph.vu.v1.OverviewGen1.ControlActivity.control_time:type_name -> google.protobuf.Timestamp
	10, // 20: wayplatform.connect.tachograph.vu.v1.OverviewGen1.ControlActivity.control_card_number:type_name -> wayplatform.connect.tachograph.dd.v1.FullCardNumber
	6,  // 21: wayplatform.connect.tachograph.vu.v1.OverviewGen1.ControlActivity.download_period_begin_time:type_name -> google.protobuf.Timestamp
	6,  // 22: wayplatform.connect.tachograph.vu.v1.OverviewGen1.ControlActivity.download_period_end_time:type_name -> google.protobuf.Timestamp
