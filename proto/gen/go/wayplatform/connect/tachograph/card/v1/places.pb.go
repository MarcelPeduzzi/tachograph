...
func (x *Places) GetAuthentication() *v11.Authentication {
	if x != nil {
...
func (x *Places) SetAuthentication(v *v11.Authentication) {
...
func (x *Places) HasAuthentication() bool {
	if x == nil {
		return false
	}
...
func (x *Places) ClearAuthentication() {
...
const file_wayplatform_connect_tachograph_card_v1_places_proto_rawDesc = "" +
	...
	"\x0eauthentication\x18c \x01(\v2:.wayplatform.connect.tachograph.security.v1.AuthenticationR\x0eauthenticationB\xd8\x02\n" +
...
var file_wayplatform_connect_tachograph_card_v1_places_proto_depIdxs = []int32{
	...
	2, // 1: wayplatform.connect.tachograph.card.v1.Places.authentication:type_name -> wayplatform.connect.tachograph.security.v1.Authentication
