...
func (x *DetailedSpeedGen1) GetAuthentication() *v1.Authentication {
	if x != nil {
...
func (x *DetailedSpeedGen1) SetAuthentication(v *v1.Authentication) {
...
func (x *DetailedSpeedGen1) HasAuthentication() bool {
	if x == nil {
		return false
	}
...
func (x *DetailedSpeedGen1) ClearAuthentication() {
...
var file_wayplatform_connect_tachograph_vu_v1_detailed_speed_gen1_proto_depIdxs = []int32{
	...
	2, // 1: wayplatform.connect.tachograph.vu.v1.DetailedSpeedGen1.authentication:type_name -> wayplatform.connect.tachograph.security.v1.Authentication
	3, // 2: wayplatform.connect.tachograph.vu.v1.DetailedSpeedGen1.DetailedSpeedBlock.begin_date:type_name -> google.protobuf.Timestamp
